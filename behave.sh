...
behave_steps()
{
        ...
        sudo mkdir -p /var/lib/jenkins/workspace/behave/features/steps
        sudo cp -r ./test.feature /var/lib/jenkins/workspace/behave/features
        sudo cp -r ./test.py /var/lib/jenkins/workspace/behave/features/steps
        behave
